        ...
        fluidRow(
          box(
            ...
            <div class='highlight-box'>
              <h4>🏆 Major Finding: Workers with disabilities provide 3.4x higher net value</h4>
      ...
      tabItem(tabName = "references",
        fluidRow(
          box(
            ...
            HTML("
            <h4>Fisher, S. L., & Connelly, C. E. (2020). Building the 'Business Case' for Hiring People with Disabilities: A Financial Cost-Benefit Analysis Methodology and Example. <em>Canadian Journal of Disability Studies, 9</em>(4), 71–88.</h4>
        ...
        fluidRow(
          box(
            ...
            HTML("
            <h5>📊 Supporting Research Evidence:</h5>
...
server <- function(input, output, session) {
  ...
  output$executive_summary <- renderUI({
    ...
    <div class='info-box'>
      ...
      <div class='highlight-box'>
        <h5>🎯 Primary Finding: $15,483 Annual Advantage</h5>
      ...
      <p><strong>Strategic Implication:</strong> Disability employment is not just about social responsibility—
  ...
  output$financial_benefits <- renderUI({
    ...
    <div class='info-box'>
      ...
      <h5>💰 Direct Financial Advantages:</h5>
      <ul>
...
if(length(disabled_net) > 0 && !is.na(disabled_net) && !is.na(nondisabled_net)) {
  cat("• **Net Value per Employee with Disabilities:** $", format(round(disabled_net), big.mark = ","), " annually\\n")
  cat("• **Net Value per Employee without Disabilities:** $", format(round(nondisabled_net), big.mark = ","), " annually\\n")
  cat("• **Annual Advantage per Employee:** $", format(round(advantage), big.mark = ","), "\\n")
  cat("• **Total Annual Advantage for ", num_disabled, " employees:** $", format(round(total_advantage), big.mark = ","), "\\n")
  ...
  if(accommodation_annual > 0 && advantage > 0) {
    ...
    cat("• **ROI on Accommodation Costs:** ", roi_percent, "%\\n")
  } else if(accommodation_annual == 0) {
    cat("• **ROI on Accommodation Costs:** Infinite (no annual accommodation costs)\\n")
  } else {
    cat("• **ROI on Accommodation Costs:** N/A\\n")
  }
} else {
  cat("• **Error in calculations - please check input parameters**\\n")
}
...
The data demonstrates that employing workers with disabilities is not just a social responsibility—it\'s a financially advantageous business strategy.
